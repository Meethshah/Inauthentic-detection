...
urlpatterns = [
    ...
    url(r'^Predict_Profile_Identification_Status/$', remoteuser.Predict_Profile_Identification_Status, name="Predict_Profile_Identification_Status"),
    ...
    url(r'^View_Profile_Identity_Prediction_Ratio/$', serviceprovider.View_Profile_Identity_Prediction_Ratio,name="View_Profile_Identity_Prediction_Ratio"),
    ...
    url(r'^View_Profile_Identity_Prediction/$', serviceprovider.View_Profile_Identity_Prediction, name="View_Profile_Identity_Prediction"),
